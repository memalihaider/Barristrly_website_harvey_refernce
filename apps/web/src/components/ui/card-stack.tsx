              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "cursor-grab active:cursor-grabbing border-white/20 shadow-primary/5"
                      : "cursor-pointer",
                  )}
                  style={{
                    width: cardWidth,
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          {activeItem.href ? (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="text-gray-500 hover:text-primary transition p-1 rounded-full hover:bg-black/5 dark:hover:bg-white/5"
  ...
  return (
    <div className="relative h-full w-full bg-black">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6 text-white">
        ...
        {item.description ? (
          <div className="mt-1.5 line-clamp-2 text-sm text-white/80 leading-relaxed">
            {item.description}
          </div>
        ) : null}
      </div>
